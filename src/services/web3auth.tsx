...
export const Web3AuthProvider: FunctionComponent<IWeb3AuthState> = ({ children, web3AuthNetwork, chain }: IWeb3AuthProps) => {
  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        setIsLoading(true);
        const clientId = "BFFQhfg_oeXZOEP3Uvn0-L7Lw6vloCu17ZpflqdM4W8qKhP3Q9MBJiT3qxgYobHFZxUk03cPnXwp5-aceqPQ67I";
  ...
  adapterSettings: {
    clientId: "BFFQhfg_oeXZOEP3Uvn0-L7Lw6vloCu17ZpflqdM4W8qKhP3Q9MBJiT3qxgYobHFZxUk03cPnXwp5-aceqPQ67I", 
    network: "testnet",
    uxMode: "popup",
    loginConfig: {
      jwt: {
        name: "sms-auth0",
        verifier: "xade-auth0-google",
        typeOfLogin: "jwt",
        clientId: "F4qq6RsSV7Rd77pqKvOuIvCKrHZ4xzDr",
      },
    },
  },
});
     ...
     WALLET_ADAPTERS.OPENLOGIN,
      {
        ...
        loginProvider: "jwt",
        extraLoginOptions: {
          domain: "https://xade-finance.us.auth0.com/",
          verifierIdField: "sub",
        },
      }
    );
